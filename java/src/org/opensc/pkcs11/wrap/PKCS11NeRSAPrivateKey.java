 ...
 * @author wglas
 *
 * This is a non-extractable RSA private key stored on the token.
 */
public class PKCS11NeRSAPrivateKey extends PKCS11PrivateKey implements RSAKey
{
	/**
	 * To be changed upon class layout change.
	 */
	private static final long serialVersionUID = 717071262806506219L;
	 ...
	 */
	protected PKCS11NeRSAPrivateKey(PKCS11Session session, long handle) throws PKCS11Exception
	{
