...
/**
 * The <code>or</code> choice of a SecurityCondition.
 * 
 * @author wglas
 */
public class OrSecurityCondition extends SecurityCondition {

    private List<SecurityCondition> conditions;
    
    /**
     * @param condition The SecurityConditions or'd by this condition.
     */
    public OrSecurityCondition(List<SecurityCondition> conditions) {
     ...
     */
    public static OrSecurityCondition getInstance(Object obj) {
        
        if (obj instanceof OrSecurityCondition)
            return (OrSecurityCondition)obj;
        ...
        if (obj instanceof ASN1Sequence) {
            ...
            return new OrSecurityCondition(conditions);
        }
        
        throw new IllegalArgumentException("SecurityCondition.or must be encoded as an ASN.1 SEQUENCE.");
